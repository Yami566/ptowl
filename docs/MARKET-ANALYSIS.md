# PTowl — Market Analysis & Expansion Strategy
...
PTowl's core innovation — **5 keypresses to a complete schedule** — solves a universal problem: recurring appointment scheduling is slow, mouse-heavy, and overbuilt in every existing tool. Combined with a proprietary de-identification methodology (sports aliases replacing real patient names), the product occupies a unique position at the intersection of speed and privacy.
...
| Vertical       | Top Competitors                 | Their Pricing | Their Weakness                                              | PTowl Advantage                                        |
| -------------- | ------------------------------- | ------------- | ----------------------------------------------------------- | ------------------------------------------------------ |
...
Canonical pricing is maintained in [BUSINESS-PLAN-CANVAS.md](BUSINESS-PLAN-CANVAS.md). Reproduced here for convenience:

| Tier                    | Price               | Includes                                                     | Target                      |
| ----------------------- | ------------------- | ------------------------------------------------------------ | --------------------------- |
| **Free**                | $0/mo               | Up to 3 active patients, all features                        | Solo provider trying it out |
...
| **Future: White-label** | $0.05/patient/mo    | Embed PTowl into other PT-SaaS                               | OEM partners                |

**Pricing position:** Well below full EHR systems ($99-$399/mo). The Solo tier ($9/mo) deliberately undercuts every generic scheduler and positions PTowl as "the schedule you'd already pay $30/mo for, except $9." The Clinic tier scales linearly per provider so multi-clinic adoption doesn't punish growth.

**Monetization is gated.** Per [PTOWL-NORTH-STAR.md](PTOWL-NORTH-STAR.md), no paid tier ships until 50+ active beta clinics validate the free experience. Until then, every user is on the free beta and tier gates are not enforced in code.
...
**Short-term (60-90 days):** 4. LinkedIn posts targeting PT clinic owners 5. YouTube 60-second demo videos (SEO: "PT scheduling software") 6. State PT association chapter meetings

**Medium-term (6-12 months):** 7. APTA CSM conference innovation showcase ($2,000-$5,000 booth) 8. Integration partnerships with WebPT/Jane App 9. Content SEO: "HIPAA compliant scheduling," "PT schedule templates"
...
1. Public Show HN flip with free beta tier; LemonSqueezy + paid tiers (Solo $9/mo, Clinic $29/mo per provider) gated on 50 active beta clinics per [PTOWL-NORTH-STAR.md](PTOWL-NORTH-STAR.md)
...
4. **$9/mo Solo and $29/mo per-provider Clinic** are the right starting tiers — well below EHR pricing, deliberately undercutting generic schedulers. See [BUSINESS-PLAN-CANVAS.md](BUSINESS-PLAN-CANVAS.md) for canonical pricing.

5. **First 100 users will come from Reddit, Facebook groups, and local clinic demos** — not paid ads or app stores.

---

_Market data from Bureau of Labor Statistics, IBISWorld, and Grand View Research (through early 2025). Competitor pricing reflects publicly listed prices and may have changed._
