...
| **[docs/SHIP.md](./docs/SHIP.md)**           | Launch playbook: T-24h → T+24h checklist, cross-post templates, screencast script, 5-channel beta outreach. The "how it gets out the door."                   |
