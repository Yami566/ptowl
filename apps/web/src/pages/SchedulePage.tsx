...
const styles: Record<string, React.CSSProperties> = {
  ...
  infoBar: { maxWidth: 'clamp(720px, 65vw, 1200px)', margin: '0 auto', padding: '1.5rem 1.5rem 0.5rem', display: 'flex', alignItems: 'baseline', gap: '1rem', flexWrap: 'wrap' as const },
  ...
  statsBar: { maxWidth: 'clamp(720px, 65vw, 1200px)', margin: '0 auto', padding: '0.5rem 1.5rem 0.5rem', display: 'flex', gap: '0.75rem', flexWrap: 'wrap' as const },
  ...
  table: { width: '100%', maxWidth: 'clamp(720px, 65vw, 1200px)', margin: '1rem auto', borderCollapse: 'collapse' as const, background: 'var(--white)', borderRadius: 'var(--radius-lg)', overflow: 'hidden' as const },
