        ...
        <header style={s.header} className="ptowl-header">
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }} className="ptowl-header-actions">
            <details style={s.menuRoot} className="ptowl-menu">
              <summary style={s.menuSummary} aria-label="Open profile menu">
                Profile &#9662;
              </summary>
              <div style={s.menuPanel} role="menu">
                <button style={s.menuItem} role="menuitem" onClick={() => navigate('/dashboard')}>
                  Dashboard
                </button>
                <button style={s.menuItem} role="menuitem" onClick={() => navigate('/profile')}>
                  Profile &amp; Clinic Info
                </button>
                <button
                  style={s.menuItem}
                ...
                <div style={s.row}>
                  <div style={s.field}>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setEditValue(template.id, 'sessions_per_week', Number(e.target.value))
                      }
                    >
                      {[1, 2, 3, 4, 5, 6, 7].map((n) => (
                  ...
                  <div style={s.field}>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setEditValue(template.id, 'duration_weeks', Number(e.target.value))
                      }
                    >
